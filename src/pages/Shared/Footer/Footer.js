    ...
    return (
        <div className='container-fluid '>
            ...
            <div class="w-full min-h-screen flex items-center justify-center bg-black">
                <div class=" w-full lg:px-20 px-5 text-white text-left flex flex-col">
                    <div class="w-full lg:text-5xl text-3xl font-bold">
                        <h1 class="w-full md:w-3/4">TO JOIN OUR SPEEDDO CLUB CONTACT WITH US</h1>
                    </div>
                    ...
                    <div class="flex flex-col">
                        ...
                        <p class="w-full text-center my-5 text-gray-600">Copyright © 2022 Speeddo All Rights Reserved</p>
                    </div>
                </div>
            </div>
        </div>
