    ...
    return (
        <div
            ...
            <div className='absolute  items-center justify-center lg:top-20'>
                <img className='mx-auto lg:h-40 lg:w-40 h:10 w-10 rounded-full border border-white lg:p-2' src="https://images.unsplash.com/photo-1504909595448-91378747b0cb?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1yZWxhdGVkfDE5fHx8ZW58MHx8fHw%3D&auto=format&fit=crop&w=600&q=60" alt="" />
